...
<div class="titre_description_massage">
    ...
    if ($titre_description) : ?>
        ...
        <?php //if ($titre_description['sous-titre']): ?>
            ...
            <!-- <h3 class="page_subtitle">Aide au <span style="color: var(--orange-massage);">lâcher-prise</span><br>
            invitation au <span style="color: var(--orange-massage)">voyage</span></h3> -->
        <?php //endif; ?>
